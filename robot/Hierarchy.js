...
var feetMatrixLocal = new Matrix4().setScale(3, 1, 6);
...
function handleKeyPress(event) {
    ...
    switch (ch) {
        ...
        case "T":
            ...
            torsoMatrix.setTranslate(0, 0, 0).rotate(torsoAngle, 0, 1, 0);
            legsAngle += 15;
            leftLegMatrix.setTranslate(-2, -11, 0).rotate(legsAngle, 0, 1, 0);
            rightLegMatrix.setTranslate(2, -11, 0).rotate(legsAngle, 0, 1, 0);
            break;
        case "s":
        case "S":
            shoulderAngle += 15;
        ...
        case "M":
            legsAngle -= 15;
            var currentLegsRot = new Matrix4()
                .setTranslate(0, 5, 0)
